...
package JNI_Binding.Standard_JNI.Constraint_Error_JNI is 
   ...
   function Id_JNI_460 (Message : Standard.String) return access Ada.Exceptions.Exception_Occurrence;

   function createOccurrence_Id_JNI_459 (Id_JNI_1 : Interfaces.Java.JNI.JNI_Env_Access; Id_JNI_3 : Interfaces.Java.JNI.J_Class; Message : Interfaces.Java.JNI.J_Int_J_Array) return Interfaces.Java.JNI.J_Int_J_Array;
   pragma Export (C, createOccurrence_Id_JNI_459, "Java_adarecord_Standard_Constraint_1Error_createOccurrence_1Id_1JNI_1459___3I");
