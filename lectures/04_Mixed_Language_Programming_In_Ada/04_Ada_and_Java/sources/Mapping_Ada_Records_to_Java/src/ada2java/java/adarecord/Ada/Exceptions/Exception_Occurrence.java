...
package adarecord.Ada.Exceptions;
...
public final class Exception_Occurrence extends com.adacore.ajis.internal.ada.AdaProxy {
   ...
   final public int [] internalClone () {
      ...
      try {
         int [] Id_JNI_10;
         adarecord.Ada.Exceptions.Exception_Occurrence Id_JNI_11 = this;
         if (Id_JNI_11 == null) {
   ...
   public void deallocateNativeObject () {
      ...
      try {
         int [] Id_JNI_36;
         adarecord.Ada.Exceptions.Exception_Occurrence Id_JNI_37 = this;
         if (Id_JNI_37 == null) {
