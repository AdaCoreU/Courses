pragma Ada_95;
with System;
package jprintermain is
   pragma Warnings (Off);

   procedure jprinterinit;
   pragma Export (C, jprinterinit, "jprinterinit");

   procedure jprinterfinal;
   pragma Export (C, jprinterfinal, "jprinterfinal");
   ...
   u00003 : constant Version_32 := 16#2de6db38#;
   pragma Export (C, u00003, "jni_binding__standard_jniB");
   u00004 : constant Version_32 := 16#6776ee28#;
   pragma Export (C, u00004, "jni_binding__standard_jniS");
   u00005 : constant Version_32 := 16#e05d8bd5#;
   pragma Export (C, u00005, "jni_binding__standard_jni__storage_error_jniB");
   u00006 : constant Version_32 := 16#d5f8190a#;
   pragma Export (C, u00006, "jni_binding__standard_jni__storage_error_jniS");
   u00007 : constant Version_32 := 16#313af29e#;
   pragma Export (C, u00007, "jni_binding__standard_jni__program_error_jniB");
   u00008 : constant Version_32 := 16#982f4cd8#;
   pragma Export (C, u00008, "jni_binding__standard_jni__program_error_jniS");
   u00009 : constant Version_32 := 16#76e3769e#;
   pragma Export (C, u00009, "jni_binding__standard_jni__constraint_error_jniB");
   u00010 : constant Version_32 := 16#7d56ba63#;
   pragma Export (C, u00010, "jni_binding__standard_jni__constraint_error_jniS");
   u00011 : constant Version_32 := 16#f1258196#;
   pragma Export (C, u00011, "jni_binding__standard_jni__adastring_jniB");
   u00012 : constant Version_32 := 16#2290a4f7#;
   pragma Export (C, u00012, "jni_binding__standard_jni__adastring_jniS");
   u00013 : constant Version_32 := 16#8653fe9a#;
   pragma Export (C, u00013, "jni_binding__jprinter_jniB");
   u00014 : constant Version_32 := 16#5840c71e#;
   pragma Export (C, u00014, "jni_binding__jprinter_jniS");
   u00015 : constant Version_32 := 16#d0141261#;
   pragma Export (C, u00015, "jni_binding__jprinter_jni__print_cb_jniB");
   u00016 : constant Version_32 := 16#9e7c76eb#;
   pragma Export (C, u00016, "jni_binding__jprinter_jni__print_cb_jniS");
   u00017 : constant Version_32 := 16#00cc2c0a#;
   pragma Export (C, u00017, "jni_binding__jprinter_jni__jprinter_package_jniB");
   u00018 : constant Version_32 := 16#5a793dd4#;
   pragma Export (C, u00018, "jni_binding__jprinter_jni__jprinter_package_jniS");
   u00019 : constant Version_32 := 16#73bdce17#;
   pragma Export (C, u00019, "jni_binding__jprinter_jni__id_jni_42_jniB");
   u00020 : constant Version_32 := 16#a91c623a#;
   pragma Export (C, u00020, "jni_binding__jprinter_jni__id_jni_42_jniS");
   ...
   u00029 : constant Version_32 := 16#cbc14d2e#;
   ...
   u00031 : constant Version_32 := 16#9cd94142#;
   pragma Export (C, u00031, "jprinterB");
   u00032 : constant Version_32 := 16#e264ed88#;
   pragma Export (C, u00032, "jprinterS");
   ...
   --  jni_binding.jprinter_jni%s
   --  jni_binding.jprinter_jni%b
   --  jni_binding.standard_jni%s
   --  jni_binding.standard_jni%b
   --  jni_binding.jprinter_jni.id_jni_42_jni%s
   --  jni_binding.jprinter_jni.jprinter_package_jni%s
   --  jni_binding.jprinter_jni.print_cb_jni%s
   --  jni_binding.jprinter_jni.print_cb_jni%b
   --  jni_binding.jprinter_jni.jprinter_package_jni%b
   --  jni_binding.jprinter_jni.id_jni_42_jni%b
