...
package JNI_Binding.Standard_JNI.Program_Error_JNI is 
   ...
   function Id_JNI_349 (Message : Standard.String) return access Ada.Exceptions.Exception_Occurrence;

   function createOccurrence_Id_JNI_348 (Id_JNI_1 : Interfaces.Java.JNI.JNI_Env_Access; Id_JNI_3 : Interfaces.Java.JNI.J_Class; Message : Interfaces.Java.JNI.J_Int_J_Array) return Interfaces.Java.JNI.J_Int_J_Array;
   pragma Export (C, createOccurrence_Id_JNI_348, "Java_quiz_Standard_Program_1Error_createOccurrence_1Id_1JNI_1348___3I");
